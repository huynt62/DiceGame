<template>
    <div class="wrapper-control">
        ...
        <!-- 
            ...
            Nếu nó không phải là data trực tiếp của Component Control -> Nó không được phép thay đổi
         -->
    </div>
</template>
...
export default {
    name: 'controls',
    props: {
        finalScore: { type: [Number, String], default: null },
